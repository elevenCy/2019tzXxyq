package com.winter.model.manage.dimTourBasResource;
...
/**
 * @name DimTourBasResource
 * @Description DimTourBasResource实体对象
 * @author tujing
 * @date 2016-07-01
 */
@Alias("DimTourBasResource")
public class DimTourBasResource extends BaseEntity {
