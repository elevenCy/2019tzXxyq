package com.winter.model.manage.dimTourDevcAmmeter;
...
/**
 * @name DimTourDevcAmmeter
 * @Description DimTourDevcAmmeter实体对象
 * @author tujing
 * @date 2016-07-01
 */
@Alias("DimTourDevcAmmeter")
public class DimTourDevcAmmeter extends BaseEntity {
